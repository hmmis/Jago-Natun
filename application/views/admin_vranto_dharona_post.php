					...
					<div class="widget-box" id="widget-box-1">
						...
						<div class="widget-body">
							<div class="widget-main">
								<form method="POST" action="<?php echo base_url()?>/admin/submit_vranto_dharona_post" class="form-inline">
								...
								<table class="table">
									...
									<?php foreach ($old_post as $o): ?>
										<tr>
											...
											<td><a href="<?php echo base_url()?>admin/edit_vranto_dharona/<?php echo $o['jano_janao_id'] ?>">Edit</a></td>

											<td><a href="<?php echo base_url()?>admin/delete_vranto_dharona/<?php echo $o['jano_janao_id'] ?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
										</tr>
									<?php endforeach ?>
								</table>
							</div>
